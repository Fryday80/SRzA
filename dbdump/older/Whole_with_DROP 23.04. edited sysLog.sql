...
--
-- Host: localhost
-- Erstellungszeit: 23. Apr 2017 um 19:24
...
(1, 1, 'Doctor', 'who', 'm', '1784-04-22', 2, 2, 0, 0, 0, 'dsadsadas', 1),
(2, 1, 'Susanaaaa', 'Foreman', 'f', '1748-04-07', 2, 2, 1, 0, 0, 'jgfjjdj', 0),
(3, 1, 'Sandy', 'Sand', 'f', '2017-04-09', 2, 3, 0, 1, 2, '', 0),
(4, 0, 'Basti', 'Bast', 'm', '1715-07-29', 2, 3, 0, 1, 2, '', 0),
(9, 1, 'stefan', 'dsadsad', 'm', '2017-04-23', 0, 0, 0, 0, 0, 'fdfdf', 0);
...
INSERT INTO `system_log` (`time`, `type`, `msg`, `url`, `userId`, `userName`, `data`) VALUES
(345345, 'test', 'test msg', 'test title', NULL, NULL, NULL);
...
(1, 'salt@salt.de', 'salt', '88f716c2b137f811a8ebe9ea10a7867d7b9e7622', NULL, 1, 152151515113, 20161008200020, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
