...
--
-- Host: localhost
-- Erstellungszeit: 08. Apr 2017 um 21:26
...
(1, 0, 'User Rights', '/user', 67, 33, 34),
(2, 0, 'Resources', '/resource', 62, 39, 40),
(3, 0, 'Permissions', '/permission', 58, 37, 38),
(4, 0, 'Users', '/user', 67, 22, 23),
(5, 0, 'Gallery Edit', '/album', 66, 30, 31),
(7, 0, 'Home', '/', 119, 1, 2),
(8, 0, 'Navigation', '/nav/sort', 73, 42, 43),
(9, 0, 'Administration', '#', 69, 21, 28),
(10, 0, 'Roles', '/role', 54, 35, 36),
(11, 0, 'Content', '/cms', 69, 26, 27),
(12, 0, 'Für Veranstalter', '#', 117, 13, 20),
(13, 0, 'AGBs', '/AGB', 1, 18, 19),
(14, 0, 'Gallery', '/gallery', 81, 11, 12),
(15, 0, 'Webmaster', '#', 69, 29, 46),
...
(24, 0, 'FileBrowser', '/media/filebrowser', 143, 44, 45),
(26, 0, 'Home', '/', 1, 1, 2),
(27, 0, 'Users and Rights', '#', 54, 32, 41);
...
(4, 'testuser@example.com', 'Test', 'ed8da3d7f461715ddeb6f9217613904b1d98d4fb', 2, 1, 0, 0),
(5, 'testuser2@example.com', 'Test2', '37c7419816bc29749747704c96b655f2f7ba6d74', 3, 1, 0, 0),
(6, 'ssd@gallifrey.com', 'Doctor', '35979389c7fd8f674e5dd3474bf75b17549c850c', 4, 1, 0, 0);
