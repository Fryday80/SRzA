...
--
-- Host: localhost
-- Erstellungszeit: 17. Jun 2017 um 14:30
...
(1, 1, 'Vorstand', 'von Augsburg', 'm', '1784-04-22', 0, 0, 0, 0, 0, '', 1),
(2, 2, 'Fry', 'zu Leym', 'm', '1748-04-07', 1, 2, 0, 1, 0, '', 1),
(3, 6, 'Nane', 'zu Leym', 'f', '2017-04-09', 0, 2, 2, 0, 0, '', 1),
(4, 7, 'Christoph', 'zu Leym', 'm', '1715-07-29', 5, 2, 3, 0, 0, '', 1),
(9, 8, 'Lara', 'zu Leym', 'f', '2017-04-23', 0, 2, 3, 0, 0, '', 1),
(11, 9, 'Ben', 'zu Leym', 'm', '', 0, 2, 3, 0, 0, '', 1),
(12, 10, 'Basti', 'Bogi', 'm', '', 2, 3, 2, 2, 0, '', 1),
(13, 3, 'Wasser', 'Platsch', 'f', '', 4, 4, 2, 2, 0, '', 1);
...
('e46317e1612360c743333ff93dcca2fc', 1497710129, 'testuser2@example.com');
...
('activation', 'admin', 'info.srza.de', '<h3>Hallo {{name}}, dein Acoount {{email}} wurde soeben aktiviert</h3>', 'activation', 'name, email'),
...
(2, 'fryday@example.com', 'FryDay', '8b20508657fb4d3b457198e94c02ac916c72ce02', 4, 1, 67665564, 1497525541, 'Eringerstrasse', 'München', 80689, 'MN-G-02', 'Sonntag', 'Christoph', 330991200, 'm', '/media/file/_users/2/pub/profileImage.gif'),
