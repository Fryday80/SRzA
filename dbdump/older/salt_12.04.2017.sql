...
--
-- Host: localhost
-- Erstellungszeit: 11. Apr 2017 um 23:20
...
(1, 0, 'User Rights', '/user', '', 1, 33, 34),
(2, 0, 'Resources', '/resource', '', 1, 37, 38),
(3, 0, 'Permissions', '/permission', '', 0, 39, 40),
(4, 0, 'Users', '/user', '', 0, 22, 23),
(5, 0, 'Gallery Edit', '/album', '', 0, 30, 31),
(7, 0, 'Home', '/', '', 1, 1, 2),
(8, 0, 'Navigation', '/nav/sort', '', 0, 42, 43),
(9, 0, 'Administration', '#', '', 1, 21, 28),
(10, 0, 'Roles', '/role', '', 0, 35, 36),
(11, 0, 'Content', '/cms', '', 0, 26, 27),
(12, 0, 'Für Veranstalter', '#', '', 1, 13, 20),
(13, 0, 'AGBs', '/AGB', '', 1, 18, 19),
(14, 0, 'Gallery', '/gallery', '', 0, 11, 12),
(15, 0, 'Webmaster', '#', '', 1, 29, 46),
(16, 0, 'Angebote', '/Angebote', '', 0, 16, 17),
...
(23, 0, 'Links', '/links', '', 1, 47, 48),
(24, 0, 'FileBrowser', '/media/filebrowser', '', 0, 44, 45),
(26, 0, 'Home', '/', '', 1, 1, 2),
(27, 0, 'Users and Rights', '#', '', 0, 32, 41);
...
(32, 'Application\\Controller\\Page'),
...
(4, 'testuser@example.com', 'Test', 'test', 2, 1, 0, 0),
(5, 'testuser2@example.com', 'Test2', '37c7419816bc29749747704c96b655f2f7ba6d74', 3, 1, 0, 0);
