...
-- Exportiere Daten aus Tabelle DB2836034.abonnements: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle DB2836034.abonnementtypes: ~0 rows (ungefähr)
DELETE FROM `abonnementtypes`;
/*!40000 ALTER TABLE `abonnementtypes` DISABLE KEYS */;
/*!40000 ALTER TABLE `abonnementtypes` ENABLE KEYS */;
...
-- Exportiere Daten aus Tabelle DB2836034.albumimages: ~4 rows (ungefähr)
DELETE FROM `albumimages`;
/*!40000 ALTER TABLE `albumimages` DISABLE KEYS */;
INSERT INTO `albumimages` (`id`, `album_id`, `image_id`) VALUES
	(1, 1, 1),
	(2, 1, 2),
	(3, 1, 4),
	(4, 2, 3);
/*!40000 ALTER TABLE `albumimages` ENABLE KEYS */;
...
-- Exportiere Daten aus Tabelle DB2836034.albums: ~3 rows (ungefähr)
DELETE FROM `albums`;
...
-- Exportiere Daten aus Tabelle DB2836034.characters: ~3 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle DB2836034.families: ~2 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle DB2836034.hashjob: ~0 rows (ungefähr)
DELETE FROM `hashjob`;
/*!40000 ALTER TABLE `hashjob` DISABLE KEYS */;
/*!40000 ALTER TABLE `hashjob` ENABLE KEYS */;
...
-- Exportiere Daten aus Tabelle DB2836034.images: ~4 rows (ungefähr)
DELETE FROM `images`;
...
-- Exportiere Daten aus Tabelle DB2836034.job: ~1 rows (ungefähr)
DELETE FROM `job`;
...
-- Exportiere Daten aus Tabelle DB2836034.multiabo: ~0 rows (ungefähr)
DELETE FROM `multiabo`;
/*!40000 ALTER TABLE `multiabo` DISABLE KEYS */;
/*!40000 ALTER TABLE `multiabo` ENABLE KEYS */;
...
-- Exportiere Daten aus Tabelle DB2836034.nav: ~24 rows (ungefähr)
DELETE FROM `nav`;
...
-- Exportiere Daten aus Tabelle DB2836034.pages: ~13 rows (ungefähr)
DELETE FROM `pages`;
...
-- Exportiere Daten aus Tabelle DB2836034.permission: ~62 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle DB2836034.resource: ~17 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle DB2836034.role: ~4 rows (ungefähr)
DELETE FROM `role`;
...
-- Exportiere Daten aus Tabelle DB2836034.role_permission: ~144 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle DB2836034.titel: ~0 rows (ungefähr)
DELETE FROM `titel`;
...
-- Exportiere Daten aus Tabelle DB2836034.users: ~3 rows (ungefähr)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `email`, `name`, `password`, `role_id`, `status`, `created_on`, `modified_on`) VALUES
	(1, 'salt@salt.de', 'salt', '88f716c2b137f811a8ebe9ea10a7867d7b9e7622', 4, 1, 152151515113, 20161008200020),
	(2, 'fryday@example.com', 'FryDay', '8b20508657fb4d3b457198e94c02ac916c72ce02', 4, 1, 67665564, 20161008200401),
	(3, 'boluuuu@gmail.com', 'stefan', 'ed8da3d7f461715ddeb6f9217613904b1d98d4fb', 3, 1, 0, 0);
