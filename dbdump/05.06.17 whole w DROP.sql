...
--
-- Host: localhost
-- Erstellungszeit: 04. Jun 2017 um 23:09
...
INSERT INTO `mail_templates` (`id`, `sender`, `subject`, `msg`, `build_in`) VALUES
('test', 'admin', 'test', 'hilfe', 0),
('passwordForgotten', 'admin', 'pw', 'haha', 1);
...
--
-- Tabellenstruktur für Tabelle `temp_url`
--

DROP TABLE IF EXISTS `temp_url`;
CREATE TABLE IF NOT EXISTS `temp_url` (
  `id` char(50) COLLATE utf8_bin DEFAULT NULL,
