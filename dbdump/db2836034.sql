...
--
-- Host: localhost
-- Erstellungszeit: 26. Jun 2017 um 15:32
...
INSERT INTO `tent` (`id`, `user_id`, `shape`, `type`, `color`, `width`, `length`, `spare_beds`, `is_show_tent`, `is_group_equip`) VALUES
(1, 2, 1, 0, 0, 6, 4, 0, 0, 0),
(2, 1, 1, 0, 0, 3, 3, 0, 0, 0),
(3, 1, 1, 0, 0, 2, 1, 1, 0, 0),
(4, 2, 0, 0, 1, 3, 3, 2, 1, 1),
...
(8, 2, 0, 0, 1, 3, 3, 2, 1, 1),
(9, 2, 0, 0, 1, 3, 3, 2, 1, 1),
(10, 2, 0, 0, 1, 3, 3, 2, 1, 1),
(11, 2, 0, 0, 1, 3, 3, 2, 1, 1),
(12, 2, 0, 0, 1, 3, 3, 2, 1, 1);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `tent_colors`
--

DROP TABLE IF EXISTS `tent_colors`;
CREATE TABLE IF NOT EXISTS `tent_colors` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` text COLLATE utf8_bin NOT NULL,
  `color1` text COLLATE utf8_bin NOT NULL,
  `color2` text COLLATE utf8_bin,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2 ;

--
-- Daten für Tabelle `tent_colors`
--

INSERT INTO `tent_colors` (`id`, `name`, `color1`, `color2`) VALUES
(1, 'natur', '#FAEBd7', NULL);
